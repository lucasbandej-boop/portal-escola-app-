...
const styles = StyleSheet.create({
  ...
  botaoVoltar: { padding: 14, backgroundColor: '#0F172A' },
  textoVoltar: { color: '#FFFFFF', fontWeight: 'bold', fontSize: 14 },
  painelTemp: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: 20 },
  tituloPainel: { fontSize: 22, fontWeight: 'bold', color: '#1E293B', marginBottom: 8 },
  nomeEscola: { fontSize: 18, fontWeight: '600', color: '#2563EB', marginBottom: 4 },
  infoEscola: { fontSize: 14, color: '#64748B', marginBottom: 24 },
  botaoSair: { backgroundColor: '#EF4444', paddingHorizontal: 24, paddingVertical: 10, borderRadius: 8 },
  textoSair: { color: '#FFFFFF', fontWeight: 'bold' },
});
